        ...
        if (enemy.gameObject.GetComponent<EnemiesReceiveDamage>() != null)
        {
            if (meleeHits > 0)
            {
                ...
                if (hitChance <= 1 && (hitChance < defDex_calc))
                {
                    ...
                    hitChance = 2;
                    meleeHits -= 1;
                    damageTaken = enemy.gameObject.GetComponent<EnemiesReceiveDamage>().attackDamage;
                    ...
                    {
                        damageTaken = (int) (damageTaken * enemy.gameObject.GetComponent<EnemiesReceiveDamage>().criticalDamage);
